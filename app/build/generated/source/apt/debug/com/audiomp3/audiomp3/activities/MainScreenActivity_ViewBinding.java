...
public class MainScreenActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public MainScreenActivity_ViewBinding(SplashScreenActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MainScreenActivity_ViewBinding(final SplashScreenActivity target, View source) {
    this.target = target;
    ...
    view = Utils.findRequiredView(source, R.id.btnRegistro, "field 'RegisterActivity' and method 'crear'");
    target.Registro = Utils.castView(view, R.id.btnRegistro, "field 'RegisterActivity'", Button.class);
    view2131230749 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
